const ENV = (function () {
    ...
    var data;
    var _base;
    (_base = String.prototype as any).lpad || (_base.lpad = function (padding, toLength) {
    ...
    function formatElapsed(value) {
        ...
        if (value > 60) {
            ...
            let seconds = (comps[0] as any).lpad('0', 2);
            let ms = comps[1];
    ...
    var body = document.querySelector('body') as any;
    var theFirstChild = (body as any).firstChild;
