...
export let TodoDef: data.DataNodeCfg<Todo> = new data.DataNodeCfgImpl<Todo>(function () { return new TodoImpl(); })
...
class TodoImpl extends data.DataSet implements Todo {
    ...
    constructor(initDmd = true) { super(TodoDef as any, initDmd); }
...
export let TodoAppDef: data.DataNodeCfg<TodoApp> = new data.DataNodeCfgImpl<TodoApp>(
...
export interface TodoApp {
    ...
    itemsLeft: number;
    filter: string;
    list: data.DataList<Todo>;
    listView: data.DataList<Todo>;
}

class TodoListImpl extends data.DataListImpl<TodoImpl> {
    constructor(initDmd = true) {
        super(TodoDef as any, initDmd);
    }
...
class TodoAppImpl extends data.DataSet implements TodoApp {
    $_newEntry = "";
    $__newEntry = "";
    $_itemsLeft = 0;
    $__itemsLeft = 0;
    ...
    constructor(initDmd = true) {
        super(TodoAppDef as any, initDmd);
        if (initDmd) {
